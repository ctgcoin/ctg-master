...
/*
 * Copyright (c) 2011, 2013, 2014, 2017 
...
#ifndef ctg_GUARD_SRC_STATISTICS_LIKELIHOOD_HH
#define ctg_GUARD_SRC_STATISTICS_LIKELIHOOD_HH 1

#include <ctg/constraint.hh>
#include <ctg/observable.hh>
#include <ctg/statistics/log-likelihood-fwd.hh>
#include <ctg/statistics/test-statistic.hh>
