...
#ifndef ctg_GUARD_SRC_UTILS_HDF5_HH
#define ctg_GUARD_SRC_UTILS_HDF5_HH 1
...
{
    /*!
     * HDF5Error is parent to all exceptions thrown by entities in namespace ctg::hdf5, e.g when creating, opening or accessing hdf5 file data.
     */
    class HDF5Error :
        public Exception
    {
