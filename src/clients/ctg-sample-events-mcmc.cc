    ...
    public InstantiationPolicy<CommandLine, Singleton>
{
    public:
        ...
        void parse(int argc, char ** argv)
        {
            ...
            Log::instance()->set_program_name("ctg-sample-events-mcmc");
...
int main(int argc, char * argv[])
{
    try
    {
        ...
        std::cout << "# Samples generated by ctg-sample-events-mcmc" << std::endl;
    ...
    catch (DoUsage & e)
    {
        ...
        std::cout << "Usage: ctg-sample-events-mcmc" << std::endl;
