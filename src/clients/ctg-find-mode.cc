...
int main(int argc, char * argv[])
{
    try
    {
        ...
        std::cout << "# Starting mode finding through ctg-find-mode" << std::endl;
        ...
        for (const auto & point: inst->starting_points)
        {
            ...
            if (inst->output.get())
            {
                ...
                YAML::Emitter out;
                out.SetIndent(4);
                out << YAML::Comment("file generated by ctg-find-mode");
    ...
    catch (DoUsage & e)
    {
        // todo update
        std::cout << e.what() << std::endl;
        std::cout << "Usage: ctg-find-mode" << std::endl;
        ...
        std::cout << "  ctg-find-mode \\" << std::endl;
