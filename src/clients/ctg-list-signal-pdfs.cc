...
struct CommandLine :
    cli::DefaultHandler
{
    virtual std::string app_name() const { return "ctg-list-signal-pdfs"; }

    virtual std::string app_synopsis() const
    {
        return "A commandline client to list the available Signal PDFs implemented in ctg.";
    }
...
int main(int argc, char ** argv)
{
    ...
    {
        CommandLine cmdline;
        cmdline.run(argc, argv, "ctg-list-signal-pdfs");
...
main(int argc, char * argv[])
{
    ...
    catch(DoUsage & e)
    {
        ...
        std::cout << "Usage: ctg-list-signal-pdfs" << std::endl;
