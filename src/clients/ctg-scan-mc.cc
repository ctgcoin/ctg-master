    ...
    public InstantiationPolicy<CommandLine, Singleton>
{
    public:
        ...
        void parse(int argc, char ** argv)
        {
            ...
            Log::instance()->set_program_name("ctg-scan-mc");
            ...
            for (char ** a(argv + 1), **a_end(argv + argc); a != a_end; ++a)
            {
                ...
                if ("--global-option" == argument)
                {
                    ...
                    {
                        Log::instance()->message("ctg-scan-mc", ll_warning)
...
int main(int argc, char * argv[])
{
    try
    {
        ...
        std::cout << "# Scan generated by ctg-scan-mc" << std::endl;
        ...
        if (inst->optimize)
        {
            ...
            Log::instance()->message("ctg-scan-mc", ll_informational)
    ...
    catch (DoUsage & e)
    {
        ...
        std::cout << "Usage: ctg-scan-mc" << std::endl;
        ...
        std::cout << "  ctg-scan-mc --kinematics s_min 14.18 --kinematics s_max 16.00 \\" << std::endl;
