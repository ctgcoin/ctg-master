...
struct CommandLine :
    cli::DefaultHandler
{
    virtual std::string app_name() const { return "ctg-list-constraints"; }

    virtual std::string app_synopsis() const
    {
        return "A commandline client to list the available statistical constraints implemented in ctg.";
    }
...
int main(int argc, char ** argv)
{
    ...
    {
        CommandLine cmdline;
        cmdline.run(argc, argv, "ctg-list-constraints");
        ...
        if (cmdline.a_dump_as_yaml.specified())
        {
            ...
            out.SetIndent(4);
            out << YAML::Comment("file generated by ctg-list-constraints\ntags used in the names of the following constraints represent references, which can be looked up using ctg-list-references");
            out << YAML::BeginMap;
