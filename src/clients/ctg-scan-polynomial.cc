    ...
    public InstantiationPolicy<CommandLine, Singleton>
{
    public:
        ...
        {
            Log::instance()->set_program_name("ctg-scan-polynomial");
...
class WilsonScannerPolynomial
{
    ...
    public:
        WilsonScannerPolynomial() :
            _output(ScanFile::Create(CommandLine::instance()->output, "ctg-scan-polynomial"))
        {
            std::cout << std::scientific;
            std::cout << "# Scan generated by ctg-scan-polynomial (" ctg_GITHEAD ")" << std::endl;
...
main(int argc, char * argv[])
{
    ...
    catch(DoUsage & e)
    {
        ...
        std::cout << "Usage: ctg-scan-polynomial" << std::endl;
