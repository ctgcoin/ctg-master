...
Parameters are stored in YAML files below \directory{ctg/parameters}, including the default values and range,
...
\filename{ctg/parameters/x.yaml} with contents:
...
\end{sourcecode}
    ...
    the file \filename{ctg/observable.cc} within the free-standing function
...
Constraints are stored in YAML files below \directory{ctg/constraints}. New constraints can be
...
\filename{ctg/constraints/x.yaml} with contents:
