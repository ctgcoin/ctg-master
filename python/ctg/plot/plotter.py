...
class Plotter:
    ...
    def plot_observable(self, item):
        ...
        info('   plotting ctg observable "{}"'.format(oname))

        # create parameters
        parameters = ctg.Parameters.Defaults()
        ...
        # create observable
        observable = ctg.Observable.make(oname, parameters, kinematics, options)
    ...
    def plot_uncertainty(self, item):
        ...
        uncfile = ctg.data.UncertaintyDataFile(h5fname)
        _xvalues = []
    ...
    def plot_contours2d(self, item):
        ...
        datafile = ctg.data.load_data_file(h5fname)
    ...
    def plot_ctg_watermark(self, item):
        ...
        ax = plt.gca()
        ax.text(x, y, r'\textsf{{\textbf{{ctg v{version}}}}}'.format(version=ctg.version()),
    ...
    def plot_contents(self):
        ...
        plot_functions = {
            ...
            'watermark':   Plotter.plot_ctg_watermark,
        }
