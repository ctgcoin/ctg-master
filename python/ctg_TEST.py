...
class PythonTests:
    ...
    def check_001_cpp_module(self):
        ...
        try:
            ...
            raise TestFailedError('importing \'_ctg\' failed: \'{}\''.format(str(e)))

        try:
            import ctg
        except ImportError as e:
            raise TestFailedError('importing \'ctg\' failed: \'{}\''.format(str(e)))

    def check_002_QualifiedName(self):
        """Check if an instance of QualifiedName can be created."""
        from ctg import QualifiedName
    ...
    def check_006_Observable(self):
        ...
        from ctg import Observable, Parameters, Kinematics, Options, QualifiedName
    ...
    def check_007_Constraint(self):
        ...
        """
        from ctg import Constraint, Options
    ...
    def check_008_Model(self):
        from ctg import Model, Parameters, Options
